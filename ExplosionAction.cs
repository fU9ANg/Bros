...
public class ExplosionAction : TriggerAction
{
	public override TriggerActionInfo Info
	{
		...
		set
		{
			this.info = (ExplosionActionInfo)value;
		}
	}
	...
	public override void Start()
	{
		...
		TriggerManager.CreateScriptedExplosion(new Vector3(blocksX, blocksY, 0f), this.info.damage);
	}
	...
	protected ExplosionActionInfo info;
}
