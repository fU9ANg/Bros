...
public class MechWeapon : Unit
{
	protected override void Awake()
	{
		base.Awake();
		this.sprite = base.GetComponent<SpriteSM>();
		if (this.mech == null && base.transform.parent != null)
		{
			this.mech = base.transform.parent.GetComponent<Mech>();
		}
		else
		{
			UnityEngine.Debug.LogError("Mech Weapon has no tank " + base.name);
		}
